...
async function main() {
  ...
  const shipmentData = [
    ...
    { id: 's004', tracking: `THL-${fmtDate(today)}-00004`, status: 'arrived' as const, senderId: 'cust-03', receiverId: 'cust-01', cod: 1200 },
    { id: 's005', tracking: `THL-${fmtDate(today)}-00005`, status: 'arrived' as const, senderId: 'cust-04', receiverId: 'cust-02', cod: 0 },
  ]
